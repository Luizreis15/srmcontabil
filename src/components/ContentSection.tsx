          ...
          <div>
            ...
            <div className="space-y-4">
              {trails.map((trail, index) => (
                <div
                  key={index}
                  className="stagger-child flex items-start gap-4 p-4 rounded-xl border border-border hover:border-primary/40 hover:bg-secondary/50 transition-all cursor-pointer group"
                >
