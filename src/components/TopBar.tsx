...
export function TopBar() {
  return (
    <div className="bg-secondary border-b border-border py-2 px-4 hidden md:block">
      <div className="container-wide mx-auto flex items-center justify-between">
        <div className="flex items-center gap-6 text-sm text-muted-foreground">
          <a href="mailto:contato@smrcontabil.com.br" className="flex items-center gap-2 hover:text-foreground transition-colors">
